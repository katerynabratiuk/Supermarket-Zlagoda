...
public class StoreProductRepositoryImpl implements StoreProductRepository {
    ...
    private static final String FIND_ALL = "SELECT UPC, product_name, selling_price " +
            "FROM Store_Product " +
    ...
    private static final String FIND_BY_ID = "SELECT Store_Product.*, Category.*, Product.*, Category.* " +
            "FROM Store_Product " +
            "JOIN Product ON Store_Product.id_product = Product.id_product " +
